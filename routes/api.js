...
router.use(function(req,res,next){
    ...
    if(req.method === 'GET'){
        //continue to next midleware or request handler
...
router.route('/person')
    ...
    .post(function (req, res) {
        res.json({
            message: 'TODO Create a new person'
        });
    });

router.route('/person/:id')
    .get(function (req, res) {
        res.json({message: 'TODO retrieve a particular person id-> ' + req.params.id});
    })
    .put(function (req, res) {
        res.json({message: 'TODO update a particular person id-> ' + req.params.id});
    })
    .delete(function(req,res){
        res.json({message: 'TODO delete a particular person id-> ' + req.params.id});
    });
